...
int32_t S7_GetDIntAt(byte Buffer[], int Pos); // Get 32 bit signed value (S7 DInt) -2147483648..2147483647

void S7_SetDIntAt(byte Buffer[], int Pos, int32_t Value); // Set 32 bit signed value (S7 DInt) -2147483648..2147483647
