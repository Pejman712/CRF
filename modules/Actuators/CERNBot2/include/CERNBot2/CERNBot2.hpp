...
class CERNBot2 : public IRobotBase {
 public:
    CERNBot2() = delete;
    CERNBot2(std::shared_ptr<communication::cansocket::ICANSocket> socket,
        const nlohmann::json& configuration);

    // Constructor used only for testing
    CERNBot2(const nlohmann::json& configuration,
    ...
    CERNBot2(const CERNBot2&) = delete;
    CERNBot2(CERNBot2&&) = delete;
    ~CERNBot2() override;
    ...
    std::shared_ptr<linearstage::ILinearStage> getLinearStage();
 ...
 private:
    ...
    std::shared_ptr<linearstage::ILinearStage> linearStage_;
