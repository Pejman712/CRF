...
class CHARMBot : public IRobotBase {
 public:
    CHARMBot() = delete;
    CHARMBot(std::shared_ptr<communication::cansocket::ICANSocket> socket,
        const nlohmann::json& configuration);

    // Constructor used only for testing
    CHARMBot(const nlohmann::json& configuration,
    ...
    CHARMBot(const CHARMBot&) = delete;
    CHARMBot(CHARMBot&&) = delete;
    ~CHARMBot() override;
