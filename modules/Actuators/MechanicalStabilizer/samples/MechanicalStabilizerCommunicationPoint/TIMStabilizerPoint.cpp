...
int main(int argc, char* argv[]) {
    ...
    crf::devices::ethercatdevices::TIMRobotArmWagonMotors motors(etherCATPort);
    ...
    std::shared_ptr<crf::actuators::mechanicalstabilizer::TIMStabilizer> stabilizer(
        new crf::actuators::mechanicalstabilizer::TIMStabilizer(motor.value()));
    ...
    std::shared_ptr<crf::actuators::mechanicalstabilizer::MechanicalStabilizerManager> manager(
        new crf::actuators::mechanicalstabilizer::MechanicalStabilizerManager(stabilizer));
    std::shared_ptr<MechanicalStabilizerCommunicationPointFactory> communicationPointFactory(
        new MechanicalStabilizerCommunicationPointFactory(manager));
