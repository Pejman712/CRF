...
using crf::communication::universalrobotrtde::IUniversalRobotRTDEInterface;

namespace crf::actuators::robot {

class UniversalRobot: public IRobot {
 public:
     UniversalRobot() = delete;
     UniversalRobot(std::shared_ptr<IUniversalRobotRTDEInterface> urRtdeInterface,
         const UniversalRobotConfiguration& robotConfigFile);
    ~UniversalRobot() override;
 ...
 private:
    ...
    UniversalRobotConfiguration robotConfiguration_;
