...
int main(int argc, char* argv[]) {
    crf::utility::logger::EventLogger logger_("testCavityMotorInPosRelative");
    ...
    while (true) {
        ...
        cavityManager->setPosition(nbrRad);
