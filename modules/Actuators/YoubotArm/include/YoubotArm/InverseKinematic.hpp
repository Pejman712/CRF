...
#ifndef INVERSE_KINEMATICS_H  // NOLINT
...
class InverseKinematics {
 public:
    ...
    /**
     * Calculate inverse position kinematics, from Task coordinates to
     * joint coordinates.
     *
     ...
     * provided as radians [rad].
     *
     * @param p_in The Task coordinates to solve for. The position
     ...
     */
    int TaskToJnt(const KDL::JntArray &q_init,
        const KDL::Frame &p_in,
        std::vector<KDL::JntArray> &q_out);  // NOLINT
 ...
 private:
     ...
     * six-dimensional Task poses (within the workspace). This IK
     ...
     *     Prentice Hall, 2005.
     *
     * @param frame The Task target frame for which the inverse
     * kinematics solves.
     *
