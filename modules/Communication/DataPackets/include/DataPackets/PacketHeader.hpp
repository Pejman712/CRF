...
class PacketHeader {
 public:
    ...
    void writerID(uint8_t writerID) const;
 ...
 private:
    ...
    int64_t timeStamp_;
    /**
     * This variable is mutable to allow it to be changed from a const method. This
     * is needed because the client assigns a writer id to the socket from an
     * upper class.
     * (jplayang & lcomte)
     *
     */
    mutable uint8_t writerID_;
