...
int main(int argc, char* argv[]) {
    ...
    std::shared_ptr<crf::actuators::robot::KinovaJaco2> kinovaRobot =
        std::make_shared<crf::actuators::robot::KinovaJaco2>(
            ...
            crf::actuators::robot::KinovaJaco2Configuration(
                configs[1]));
    ...
    std::shared_ptr<crf::actuators::robot::CombinedRobot> robot =
        std::make_shared<crf::actuators::robot::CombinedRobot>(
    ...
    std::shared_ptr<crf::control::inversekinematics::OptOLIK> inverseKinematics =
        std::make_shared<crf::control::inversekinematics::OptOLIK>(
            ...
            std::vector<double>({1, 1, 1, 1, 1e3, 1e3, 1e3, 1e3, 1e3, 1e3}),
            vecObjFun,
            0.01);
