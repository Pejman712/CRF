...
int main(int argc, char* argv[]) {
    ...
    std::shared_ptr<crf::actuators::robotbase::CERNBot2> base =
        std::make_shared<crf::actuators::robotbase::CERNBot2>(
            canSocket,
            baseJSON);
    ...
    std::shared_ptr<crf::actuators::linearstage::ILinearStage> stage = base->getLinearStage();

    std::shared_ptr<crf::control::robotbasecontroller::RobotBaseControllerManager> manager(
        new crf::control::robotbasecontroller::RobotBaseControllerManager(base, stage));
