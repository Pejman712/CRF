...
int main(int argc, char* argv[]) {
    ...
    desc.add_options()
        ...
        ("configuration", po::value<std::string>(), "Configuration file path for the CHARMBot Base")
    ...
    std::shared_ptr<crf::actuators::robotbase::CHARMBot> base =
        std::make_shared<crf::actuators::robotbase::CHARMBot>(
            canSocket,
            baseJSON);
