...
class MaxonEPOS2 : public ICANOpenMotor {
 public:
    MaxonEPOS2() = delete;
    MaxonEPOS2(uint8_t id, std::shared_ptr<communication::cansocket::ICANSocket> socket);
    MaxonEPOS2(const MaxonEPOS2&) = delete;
    MaxonEPOS2(MaxonEPOS2&&) = delete;
    ~MaxonEPOS2() override;
