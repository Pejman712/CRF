...
int main(int argc, char* argv[]) {
    ...
    auto sensor = std::make_shared<crf::devices::canopendrivers::CiA402DriverMockConfiguration>();

    sensor->configureMock();

    auto manager = std::make_shared<crf::devices::canopendrivers::CiA402Manager>(sensor);
