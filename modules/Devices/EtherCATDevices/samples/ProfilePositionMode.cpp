...
int main() {
    ...
    // ---- Position Setpoint (Relative) ------
    printf("Test 1: Position Setpoint (Relative) \n");
    printf("Position: 10000 [cnt]; \nVelocity: 1000 [cnt/s] \n"
    "Acceleration: 200 [cnt/s2] \nDeceleration: 200[cnt/s2]\n\n\n");
    motor->setProfileAcceleration(200);
    motor->setProfileDeceleration(200);
    motor->setProfileVelocity(1000);
    motor->setPosition(10000, true);
    ...
    // ---- Position Setpoint (Relative, Velocity) ----
    printf("Test 2: Position Setpoint (Relative, Velocity) \n");
    printf("Position: 10000 [cnt]; \nVelocity: 1000 [cnt/s] \n"
    "Acceleration: 2000 [cnt/s2] \nDeceleration: 200[cnt/s2]\n\n\n");
    motor->setPosition(10000, 1000, 2000, true);
    std::this_thread::sleep_for(std::chrono::seconds(15));
    motor->stop();
    // ------------------------------------------------
    ...
    // ---- Position Setpoint (Relative, Velocity, Acceleration) ----
    printf("Test 3: Position Setpoint (Relative, Velocity, Acceleration) \n");
    printf("Position: 10000 [cnt]; \nVelocity: 1000 [cnt/s] \n"
    "Acceleration: 2000 [cnt/s2] \nDeceleration: 2000[cnt/s2]\n\n\n");
    motor->setPosition(10000, 1000, 2000, 2000, true);
    ...
    // ---- Position Setpoint (Relative, Velocity, Acceleration, Deceleration) ----
    printf("Test 4: Position Setpoint (Relative, Velocity, Acceleration, Deceleration) \n");
    printf("Position: 10000 [cnt]; \nVelocity: 2000 [cnt/s] \n"
    "Acceleration: 2000 [cnt/s2] \nDeceleration: 2000[cnt/s2]\n\n\n");
    motor->setPosition(10000, 2000, 2000, 2000, true);
    std::this_thread::sleep_for(std::chrono::seconds(10));
    motor->stop();
    // ------------------------------------------------
