...
class DeviceManagerWithPriorityAccess : public DeviceManagerWithAutoInitialization {
 ...
 protected:
     ...
     *        and the control access timeout. This operation initializes the device if the priority
     *        is valid and it was deinitlized. It also updates the last request time.
