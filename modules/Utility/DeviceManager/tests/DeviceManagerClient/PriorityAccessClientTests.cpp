...
class PriorityAccessClientShould : public ::testing::Test {
 protected:
    PriorityAccessClientShould() :
        logger_("PriorityAccessClientShould"),
    ...
    std::unique_ptr<crf::utility::devicemanager::PriorityAccessClient> sut_;
...
TEST_F(PriorityAccessClientShould, initializeDeinitializeSequence) {
    sut_.reset(new crf::utility::devicemanager::PriorityAccessClient(
        packetSocket_, std::chrono::milliseconds(10000), 0, 1));
...
TEST_F(PriorityAccessClientShould, opensTheSocketIfItWasNotOpen) {
    sut_.reset(new crf::utility::devicemanager::PriorityAccessClient(
        packetSocket_, std::chrono::milliseconds(10000), 0, 1));
...
TEST_F(PriorityAccessClientShould, printInLoggerIfWrongCommand) {
    sut_.reset(new crf::utility::devicemanager::PriorityAccessClient(
        packetSocket_, std::chrono::milliseconds(10000), 0, 1));
...
TEST_F(PriorityAccessClientShould, printInLoggerIfCommandIsNotReply) {
    sut_.reset(new crf::utility::devicemanager::PriorityAccessClient(
        packetSocket_, std::chrono::milliseconds(10000), 0, 1));
...
TEST_F(PriorityAccessClientShould, printInLoggerIfReplyCommandDoesNotMatch) {
    sut_.reset(new crf::utility::devicemanager::PriorityAccessClient(
        packetSocket_, std::chrono::milliseconds(10000), 0, 1));
...
TEST_F(PriorityAccessClientShould, printInLoggerIfReplyIsAnError) {
    sut_.reset(new crf::utility::devicemanager::PriorityAccessClient(
        packetSocket_, std::chrono::milliseconds(10000), 0, 1));
...
TEST_F(PriorityAccessClientShould, streamStatusAnswerGoesThroughStatusUpdate) {
    sut_.reset(new crf::utility::devicemanager::PriorityAccessClient(
        packetSocket_, std::chrono::milliseconds(10000), 0, 1));
...
TEST_F(PriorityAccessClientShould, correctlyStartStreamWithDesiredFrequency) {
    sut_.reset(new crf::utility::devicemanager::PriorityAccessClient(
        packetSocket_, std::chrono::milliseconds(10000), 1, 1));
    ...
    sut_.reset(new crf::utility::devicemanager::PriorityAccessClient(
        packetSocket_, std::chrono::milliseconds(10000), 10, 1));
...
TEST_F(PriorityAccessClientShould, correctlyStopStream) {
    sut_.reset(new crf::utility::devicemanager::PriorityAccessClient(
        packetSocket_, std::chrono::milliseconds(10000), 1, 1));
