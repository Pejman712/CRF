...
#include "VisionUtility/PointCloud/Convexhullr.hpp" 
...
int main(int argc, char** argv) {
    ...
    try {
        for (size_t i = 1; i < pcdFiles.size(); ++i) {
            ...
            cloud_filtered_target = crf::utility::visionutility::pointcloud::convexhullr::rotateTargetCloud(
    cloud_filtered_source, cloud_filtered_target);
