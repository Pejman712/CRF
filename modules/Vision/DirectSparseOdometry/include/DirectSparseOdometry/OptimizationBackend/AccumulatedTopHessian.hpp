...
#include "DirectSparseOdometry/OptimizationBackend/MatrixAccumulators.hpp"
...
//         std::cout << "Entered stitchDoubleMT" << std::endl;
...
//             std::cout << "red->reduce successful" << std::endl;
