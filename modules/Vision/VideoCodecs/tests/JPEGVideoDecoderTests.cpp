...
using crf::vision::videocodecs::JPEGVideoDecoder;
using crf::vision::videocodecs::CompressionQuality;
...
TEST_F(JPEGVideoDecoderShould, correctlyDecodeFrames) {
    ...
    sut_.reset(new JPEGVideoDecoder());
    encoder_.reset(new JPEGVideoEncoder(crf::vision::videocodecs::CompressionQuality::Normal));
