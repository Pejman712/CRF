...
Instructions() {
    ...
    echo "      RP Survey with the TIM58. These are: "
    echo ""
...
TIM() {
    sudo -b -E ./../bin/TIMS300Point --protocol tcp --port 4000 --configuration ../modules/Actuators/TIM/config/TIM58.json
}

TIMRPWagonArm() {
    sudo -b -E ./../bin/TIMS300RPWagonPoint --protocol tcp --port 3002 --configuration ../modules/Actuators/TIMRPWagon/config/TIM58RPWagon.json
}
...
StartPoints() {
    ...
    echo "     - TIM58                |  TCP Port 4000"
    echo "     - TIM58 RP Wagon       |  TCP Port 3002"
    echo "     - RP Sensor            |  TCP Port 8000"
    echo "     - Oxygen Sensor        |  TCP Port 8001"
    echo "     - Temperatur Sensor    |  TCP Port 8002"
    echo "     - RP Survey Mission    |  TCP Port 5000"
